...
describe("Account Print Statement", () => {
    ...
    it("prints all transactions", () => {
        ...
        expect(getPrintedLineByIndex(consoleObj,0)).toEqual("Date || Amount || Balance");
        expect(getPrintedLineByIndex(consoleObj,1)).toEqual("14/01/2012 || -500 || 2500")
        expect(getPrintedLineByIndex(consoleObj,2)).toEqual("13/01/2012 || 2000 || 3000")
        expect(getPrintedLineByIndex(consoleObj,3)).toEqual("10/01/2012 || 1000 || 1000")
    });
});
